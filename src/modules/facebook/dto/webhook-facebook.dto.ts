...
class SenderDto {
  @ApiProperty({ example: '<PSID>', description: 'Sender ID' })
  @IsString()
  @IsNotEmpty()
  id: string;
}
...
class RecipientDto {
  @ApiProperty({ example: '<PAGE_ID>', description: 'Recipient ID' })
  @IsString()
  @IsNotEmpty()
  id: string;
}
...
class PayloadDto {
  @ApiProperty({ example: 'URL', description: 'Attachment URL' })
  @IsString()
  @IsNotEmpty()
  url: string;
...
class AttachmentDto {
  @ApiProperty({ example: 'fallback', description: 'Attachment type' })
  @IsString()
  @IsNotEmpty()
  type: string;

  @ApiProperty({ type: PayloadDto, description: 'Payload information' })
  @IsObject()
  @IsNotEmpty()
  payload: PayloadDto;
}
...
class MessagePageDto {
  @ApiProperty({ example: 'm_toDnmD...', description: 'Message ID' })
  @IsString()
  @IsNotEmpty()
  mid: string;
  ...
  @ApiProperty({ example: '2020-03-24T18:16:11+00:00', description: 'Message timestamp' })
  @IsArray()
  @IsNotEmpty()
...
class messagingDto {
  @ApiProperty({ type: MessageDto, description: 'Message information' })
  @IsObject()
  @IsNotEmpty()
  sender: SenderDto;

  @ApiProperty({ type: RecipientDto, description: 'Recipient information' })
  @IsObject()
  @IsNotEmpty()
  recipient: RecipientDto;

  @ApiProperty({ example: '1583173666767', description: 'Entry timestamp' })
  @IsNumber()
  @IsNotEmpty()
  timestamp: number;

  @ApiProperty({ type: MessagePageDto, description: 'Message page information' })
  @IsObject()
  @IsNotEmpty()
  message: MessagePageDto;
}
...
class EntryDto {
  ...
  @ApiPropertyOptional({ type: MessageDto, isArray: true, description: 'List of messages' })
  @IsArray()
  @IsOptional()
...
export class WebhookFacebookDto {
  @ApiProperty({ example: 'page', description: 'Type of the object' })
  @IsString()
  @IsNotEmpty()
  object: FacebookType;
