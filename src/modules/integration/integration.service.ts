  ...
  async getIntegrationWebChat(user: User, organizationId: number, departamentoId: number): Promise<Integration> {
    ...
    if (!integration) {
      ...
      const config = {
        ...
        title: 'CONVERXA CHAT',
        cors: [],
        sub_title: 'Descubre todo lo que CONVERXA puede hacer por ti.',
        description: '¡Hola y bienvenido a CONVERXA! Estoy aquí para ayudarte a encontrar respuestas y soluciones de manera rápida y sencilla. ¿En qué puedo asistirte hoy?',
