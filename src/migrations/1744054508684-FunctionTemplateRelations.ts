...
export class FunctionTemplateRelations1744054508684 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "function_template" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying, "categoryId" integer NOT NULL, "applicationId" integer NOT NULL, "url" character varying NOT NULL, "method" character varying NOT NULL DEFAULT 'GET', "bodyType" character varying NOT NULL DEFAULT 'json', "params" text, "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_b3aa1946221bbeadb4cd1866b8b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "function_template_tag" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, CONSTRAINT "UQ_4a9a24a3d2d84369cad9ad43a85" UNIQUE ("name"), CONSTRAINT "PK_f68415860da467143807fea00bd" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "function_template_tags_function_template_tag" ("functionTemplateId" integer NOT NULL, "functionTemplateTagId" integer NOT NULL, CONSTRAINT "PK_25a46f1c9320157119b2ef75adf" PRIMARY KEY ("functionTemplateId", "functionTemplateTagId"))`);
        ...
        await queryRunner.query(`ALTER TABLE "function_template_tags_function_template_tag" ADD CONSTRAINT "FK_19817bcfeb0a9c9cf77982eaf3b" FOREIGN KEY ("functionTemplateId") REFERENCES "function_template"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "function_template_tags_function_template_tag" ADD CONSTRAINT "FK_5a331765b20a161378b2fedad44" FOREIGN KEY ("functionTemplateTagId") REFERENCES "function_template_tag"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
