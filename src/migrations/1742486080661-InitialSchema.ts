...
export class InitialSchema1742486080661 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "UserOrganizations" ("id" SERIAL NOT NULL, "role" "public"."UserOrganizations_role_enum" NOT NULL DEFAULT 'user', "deletedAt" TIMESTAMP, "userId" integer, "organizationId" integer, CONSTRAINT "PK_34f9cbade5083b765064d79617a" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "Sessions" ADD CONSTRAINT "FK_582c3cb0fcddddf078b33e316d3" FOREIGN KEY ("userId") REFERENCES "Users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "ChatSessions" ADD CONSTRAINT "FK_8f358897b9ae3a0743a81cdb91a" FOREIGN KEY ("conversationId") REFERENCES "Conversations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "Messages" ADD CONSTRAINT "FK_a5ff025977810462c680eb48bbf" FOREIGN KEY ("conversationId") REFERENCES "Conversations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "Messages" ADD CONSTRAINT "FK_7f4ef9f385a6fc56ca1acc07d11" FOREIGN KEY ("chatSessionId") REFERENCES "ChatSessions"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "Conversations" ADD CONSTRAINT "FK_d2ef5dea60a365c3d39a2bf606a" FOREIGN KEY ("userId") REFERENCES "Users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "Conversations" ADD CONSTRAINT "FK_4c8a59b0d0386da606816293257" FOREIGN KEY ("chatUserId") REFERENCES "ChatUsers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "Conversations" ADD CONSTRAINT "FK_dd894c61ff6b6bce682c3b2a8d4" FOREIGN KEY ("departamentoId") REFERENCES "departamento"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "Conversations" ADD CONSTRAINT "FK_c5ad46fe06e70af235da4e6c920" FOREIGN KEY ("integrationId") REFERENCES "Integrations"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "Integrations" ADD CONSTRAINT "FK_81bf37c8a164eb352b84269963e" FOREIGN KEY ("departamentoId") REFERENCES "departamento"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "autenticador" ADD CONSTRAINT "FK_a8376c776a5c4bc7c037ca84de3" FOREIGN KEY ("organizationId") REFERENCES "Organizations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "funcion" ADD CONSTRAINT "FK_c61e8b2365cf3f6c3489dd5b990" FOREIGN KEY ("agent_id") REFERENCES "agente"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "funcion" ADD CONSTRAINT "FK_c325aa3add633f13247408f66ea" FOREIGN KEY ("autenticador") REFERENCES "autenticador"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "knowledge_base" ADD CONSTRAINT "FK_2ce7b8636863df81e1fc9cc73fc" FOREIGN KEY ("agent_id") REFERENCES "agente"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "agente" ADD CONSTRAINT "FK_7cefc7a63f060d6a45ea01997e1" FOREIGN KEY ("departamento_id") REFERENCES "departamento"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "departamento" ADD CONSTRAINT "FK_94ea12b63f5f149437c0c9ff9a7" FOREIGN KEY ("organization_id") REFERENCES "Organizations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "UserOrganizations" ADD CONSTRAINT "FK_98c7340d3f4a85cbf599626c67e" FOREIGN KEY ("userId") REFERENCES "Users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "UserOrganizations" ADD CONSTRAINT "FK_915869dc09b36555bde1348cd30" FOREIGN KEY ("organizationId") REFERENCES "Organizations"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "system_events" ADD CONSTRAINT "FK_226fafc4fadce76691317e072f1" FOREIGN KEY ("organization_id") REFERENCES "Organizations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "system_events" ADD CONSTRAINT "FK_7c5e1be4579b00f5c7eab73fafa" FOREIGN KEY ("conversation_id") REFERENCES "Conversations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "DashboardCards" ADD CONSTRAINT "FK_1ca6bde5fd0b0f4feb8115f2b96" FOREIGN KEY ("userOrganizationId") REFERENCES "UserOrganizations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
